...
public class SwerveSubsystem extends SubsystemBase {
  ...
  public SwerveSubsystem(File directory) {
    ...
    swerveDrive.setModuleEncoderAutoSynchronize(false, 1); // Enable if you want to resynchronize
                                                           // your absolute encoders and motor
                                                           // encoders periodically when they are
                                                           // not moving.
  ...
  public Command driveToPose(Pose2d pose) {
    ...
    PathConstraints constraints = new PathConstraints(swerveDrive.getMaximumChassisVelocity(), 5.0,
  ...
  public Command sysIdDriveMotorCommand() {
    return SwerveDriveTest.generateSysIdCommand(
        SwerveDriveTest.setDriveSysIdRoutine(new Config(), this, swerveDrive, 12, true), 3.0, 5.0,
        3.0);
  }
