...
public class RobotContainer {
  ...
  private final ElevatorSubsystem elevator = useElevator ? new ElevatorSubsystem() : null;
  ...
  private void configureBindings() {
    ...
    if (DriverStation.isTest()) {
      ...
      driverXbox.rightBumper().onTrue(intake.armOuttakeCommand().alongWith(new WaitCommand(0.5))
          .andThen(intake.spitIntakeCommand()));
      ...
      driverXbox.rightStick()
          .onTrue(drivebase.driveToPose(this::autoPose).alongWith(ReefbotAutos.AutoOutput())
      ...
      driverXbox.back().onTrue(Commands.runOnce(output::runmotor).alongWith(new WaitCommand(0.025))
